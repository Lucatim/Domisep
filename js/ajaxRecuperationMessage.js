        ...
        request.done(function(d) {
            ...
            d.forEach(function (e) {
                ...
                if (sender == id_utilisateur_co && id_utilisateur_co == id_client){
                    ...
                    $(document).ready(function(){$("#messageEnvoye").click(function(){$("#message").attr('id',"ABC");});});//remplacer l'id

                    $(document).ready(function(){$("#messageEnvoye").click(function(){$("#ABC").text(message);});});//remplacer le message
                    $(document).ready(function(){$("#messageEnvoye").click(function(){$("#sujet").text(sujet);});});//remplacer le sujet
                    $(document).ready(function(){$("#messageEnvoye").click(function(){$("#nom_prenom").text(surname +" "+nom);});});//remplacer le nom et Prenom
                    $(document).ready(function(){$("#messageEnvoye").click(function(){$("#pic").attr('src',picture);});});//remplacer l'image
